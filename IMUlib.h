...
#ifndef PYTHONMODULE_IMULIB_H
#define PYTHONMODULE_IMULIB_H
...
//Quaternion updateFilterIterator(Quaternion q, Vector a, Vector w, float deltaT);    // фильтр
